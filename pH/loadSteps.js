function loadSteps() {
    ...
    var bufferText = [
        ...
        },
        {
            ...
            "longText": "Click the electrode to lower it into the solution.",
            "feedbackText": "lower the electrode"
        },
        {
            "id": "stirSolution",
            "shortText": "Swirl Solution",
            "longText": "Click the solution to gently swirl it.",
    ...
    measureText[6] = {
        ...
        "longText": "Read the pH meter. Enter the pH in the box to the left and click Submit.",
    ...
    var stepText = [
        {
            ...
            "steps": [
                {
                    "id": "openElectrodeHole",
                    "shortText": "Open Electrode",
        ...
        },
        {
            ...
            "steps": [
                ...
                {
                    "id": "selectStorageSolution",
                    "shortText": "Select Storage Solution",
                    "longText": "Click the storage solution.",
                    "feedbackText": "select the storage solution"
                },
                {
                    "id": "storeElectrode",
                    "shortText": "Store Electrode",
                    "longText": "Click the electrode to lower it into the storage solution.",
                    "feedbackText": "lower the electrode"
                },
                {
                    "id": "closeElectrodeHole",
                    "shortText": "Close Electrode",
                    "longText": "Click the light-blue part of the electrode to close the pH probe.",
                    "feedbackText": "click the light-blue part of the electrode"
                }
            ]
        }
