...
function prepChallenges() {
    ...
    var challengeData = [
        ...
        },
        {
            ...
            "title": "Efficient III",
            "desc": "Complete Challenge+ mode in under 120 seconds.",
            "flavor": "",
            "level": 3
        },
        {
        ...
        },
        {
            ...
            "desc": "Measure all of the secret objects.",
            "flavor": "",
            "level": 4
        },
        {
            "id": "secretObject",
            "title": "Hidden Object",
            "desc": "Measure one of the secret objects.",
            "flavor": "",
            "level": 3
        },
        {
...
function checkChallenges() {
    ...
    for (var i = 0; i < 19; i++) {
        ...
        if (i == 9) {
            // Read 50
            if (stats.measuredObjects >= 50) {
                proc = true;
            }
        }
        if (i == 10) {
            // Read 20
            if (stats.measuredObjects >= 20) {
                proc = true;
            }
        }
        if (i == 11) {
        ...
        if (i == 13) {
            // All secret objects
            if (secretObjectsFound() == 9) {
                proc = true;
            }
        }
        if (i == 14) {
            // One secret object
            if (secretObjectsFound() > 0) {
                proc = true;
            }
        }
        if (i == 15) {
